...
* `taiwanbusflet` - project name - lowercase, no spaces, i.e. "snake_case" identifier - used as a package name, iOS/macOS/Android bundle name and Windows/Linux executable file name.
* `TaiwanBus GUI` - project description.
* `TWBus` - project display name that is shown in window titles and about app dialogs.
* `tw.avianjay` - org name in reverse domain name notation, e.g. `com.mycompany.myproject`.
* `AvianJay` - the name of the company.
* `Copyright (C) 2025 by AvianJay` - the name of the company.
